...
namespace farmtrax {
    ...
    enum class BufferType { SHRINK, ENLARGE };
    ...
    class Field {
      ...
      public:
        ...
        const std::vector<LineString> &get_edges() const { return edges_; }

        // Calculate the area of the field
        double get_area() const { return bg::area(polygon_); }

        // Calculate the perimeter of the field
        double get_perimeter() const { return bg::perimeter(polygon_); }
      ...
      private:
        ...
        Field get_shrunk_field(double x) const {
            ...
            Multipolygon result;
            bg::buffer(polygon_, result, distance_strategy, side_strategy, join_strategy, end_strategy, point_strategy);
